 ...
 *
 */
public class _68_GRY_TextJustification {

    static class JustifiedLine {
        private final List<String> line;
        private final int maxWidth;
        private int size;

        public JustifiedLine(int maxWidth) {
    ...
    class Solution {
        public List<String> fullJustify(String[] words, int maxWidth) {
            ...
            var line = new JustifiedLine(maxWidth);
            ...
            for (int i = 0; i < len; i ++) {
                ...
                if (!line.fit(word)) {
                    ...
                    line = new JustifiedLine(maxWidth);
                }
                line.add(word);
            }
